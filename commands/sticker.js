...
async function stickerCommand(sock, chatId, message) {
    ...
    if (!mediaMessage) {
        await sock.sendMessage(chatId, { 
            text: 'ᴩʟᴇᴀꜱᴇ ʀᴇᴩʟᴀʏ ᴛᴏ ᴀɴ ɪᴍᴀɢᴇ/ᴠɪᴅᴇᴏ ᴡɪᴛʜ *.ꜱᴛɪᴄᴋᴇʀ*, ᴏʀ ꜱᴇɴᴅ ᴀɴ ɪᴍᴀɢᴇ/ᴠɪᴅᴇᴏ ᴡɪᴛʜ *.ꜱᴛɪᴄᴋᴇʀ* ᴀꜱ ᴛʜᴇ ᴄᴀᴩᴛɪᴏɴ'
    ...
    try {
        ...
        const json = {
           ...
           "sticker-pack-name": "き✯ 𝐋ɪɴᴜх 𝐒ᴇʀ ✯き",
        ...
        if (isAnimated && finalBuffer.length > 900 * 1024) {
            try {
                ...
                if (fs.existsSync(tempOutput3)) {
                    ...
                    const json2 = {
                        'sticker-pack-id': crypto.randomBytes(32).toString('hex'),
                        'sticker-pack-name': settings.packname || '𝐋ɪɴᴜх 𝐒ᴇʀ 🧃🕊️',
                        'emojis': ['🧃']
                    };
